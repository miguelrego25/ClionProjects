...
// 	Load the height map "terreno.jpg"
    ...
    vertices = (GLuint *)calloc(imageHeigth-1, sizeof(GLuint));
    glGenBuffers(imageHeigth-1, vertices);

    int halfW = imageWidth / 2;
    int halfH = imageHeigth / 2;

    vertexCount = 2 * imageWidth;

    for(int n_strip = 0; n_strip < imageHeigth - 1; n_strip++) {
